...
Ahora bien, ***definimos a una base de datos distribuida (BDD, o DDB) como una colección de múltiples bases de datos interrelacionadas de forma lógica mediante una red de computadoras o servidores***. Un Cluster de bases de datos.
